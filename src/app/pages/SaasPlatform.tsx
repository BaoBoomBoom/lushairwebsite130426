  ...
  return (
    <div className="pt-16 min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="flex items-end space-x-1 h-20">
                      {[65, 68, 72, 74, 78].map((value, index) => (
                        <div key={index} className="flex-1 bg-purple-600 rounded-t" style={{ height: `${value}%` }} />
                      ))}
                    </div>
                  </div>
                    ...
                    {[{ name: 'Oil-Control Shampoo', sales: 85 }, { name: 'Hair Mask', sales: 72 }, { name: 'Scalp Serum', sales: 68 }].map((product, index) => (
                      <div key={index}>
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div className="h-full bg-purple-700 rounded-full" style={{ width: `${product.sales}%` }} />
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        {/* CTA Section */}
        <div className="bg-purple-700 rounded-2xl p-12 text-center text-white">
